...
template<typename type, size_t _breadth, size_t _height, size_t _width>
vector <vector<type>> &
matrix<type, _breadth, _height, _width>::copy(vector <vector<type>> dest, pos z, pos y, pos dest_z) {
    dest[dest_z] = dat[z][y];
    return dat[z][y];
}
...
template<typename type, size_t _breadth, size_t _height, size_t _width>
matrix<type, _breadth, _width, _height>
matrix<type, _breadth, _height, _width>::operator=(matrix<type, _breadth, _height, _width> obj) {
    return obj;
}